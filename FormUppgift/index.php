    ...
    <div class="allt">
        ...
        <div class="FormBox">
            <form action="#" method="post" id="form" enctype="multipart/form-data">
                ...
                <input type="file" class="file" id="file" name="file" accept="image/png, image/jpeg, image/jpg, image/gif" required><br>
                <input type="submit" id="sumbitForm" name="submitForm" value="Submit">
            </form>
        </div>
        <div class="OutputBox">
            <div class="ImageBox">
            ...
            if(isset($_POST['submitForm'])){
                ...
                if(isset($fileName) and !empty($fileName)){
                    ...
                    if(move_uploaded_file($temp_name, $location.$fileName)){
                        echo '<img src="'.$location.$fileName.'" alt="ERROR">';
                    }
                } else {
